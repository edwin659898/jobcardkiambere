                                            ...
                                            <div class="card-body">
                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <Datepicker class="w-full" v-model="form.arrival_date"
                                                            position="left" altPosition></Datepicker>
                                                        <p class="text-xs text-red-600 mt-2"
                                                            v-if="form.errors.arrival_date">
                                                    ...
                                                    <table class="table table-hover text-nowrap mt-6">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(stock, index) in Jobcard.stocks" :key="index">
                                                                ...
                                                                <td>{{ stock.truck.truck_number }} - {{
                                                                    stock.truck.description }}</td>
                                                                <td>
                                                                    <p>{{ format_date(stock.arrival_time) }}</p>
                                                                </td>
                                                                <td><input v-if="stock.arrival_time == null"
                                                                        type="checkbox" v-model="form.selectedTrucks"
                                                                        :value="stock.id"
                                                                        class="rounded border-gray-300 text-green-600 shadow-sm focus:ring-green-500"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/Fruit-storage/truck-arrival-times/${id}`,
                {
