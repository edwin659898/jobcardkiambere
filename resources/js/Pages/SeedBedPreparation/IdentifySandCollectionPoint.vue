                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <select v-model="form.compartment_name" required
                                                                ...
                                                                <option v-for="(name, index) in  Compartments" :key="index" :value="name">{{ name }}</option>
                                                            </select>
                                                            ...
                                                            <p class="text-xs text-red-600 mt-2"
                                                                v-if="form.errors.compartment_name">
                                                                {{ form.errors.compartment_name }}
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="flex justify-end mt-4">
                                                            <button
                                                            @click.prevent="complete(Jobcard.id)"
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/seed-bed-preparation/identify-point-of-sand-collection/${id}`,
                {
                    onSuccess: () => this.form.compartment_name = '',
                    preserveScroll: true
                });
        },
        complete(id) {
