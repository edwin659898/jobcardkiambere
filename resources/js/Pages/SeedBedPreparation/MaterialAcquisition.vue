                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <VueMultiselect v-model="form.item_name" track-by="id" :options="Compartments"/>
                                                                <p class="text-xs text-red-600 mt-2"
                                                            ...
                                                            <div v-if="Name == 'Item'" class="w-full">
                                                                <select type="text" v-model="form.received_by" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/seed-bed-preparation/transport-sand-to-nursery/${id}`,
                {
                    onSuccess: () => {
                        this.form.item_name = ''
                        this.form.uom = ''
