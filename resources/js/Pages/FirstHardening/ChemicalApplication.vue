                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <select v-model="form.seed_bed_number" required
                                                                ...
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.seed_bed_number">
                                                                    {{ form.errors.seed_bed_number }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <select v-model="form.name" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                    <option v-for="(name, index) in  Chemicals" :key="index"
                                                                        :value="name">{{ name }}</option>
                                                                </select>
                                                                <p class="text-xs text-red-600 mt-2"
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/first-hardening/chemical-spraying/${id}`,
                {
                    onSuccess: () => {
                        this.form.name = ''
                        this.form.uom = ''
