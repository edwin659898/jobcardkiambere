                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <select v-model="form.tree_uom" required
                                                                ...
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.tree_uom">
                                                                    {{ form.errors.tree_uom }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.tree_quantity"  step=".01"
                                                                    placeholder="quantity" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.tree_quantity">
                                                                    {{ form.errors.tree_quantity }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <table class="table table-hover text-nowrap mt-6">
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(comp, index) in BedPrepActivities"
                                                                        ...
                                                                        <td>{{ comp.seed_bed_uom }}</td>
                                                                        <td>{{ comp.seed_bed_quantity }}</td>
                                                                        <td>{{ comp.tree_number_name }}</td>
                                                                        <td>{{ comp.tree_number_uom }}</td>
                                                                        <td>{{ comp.tree_number_quantity }}</td>
                                                                        <td>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/pricking-out/plant-seeds-in-pottingTubes/${id}`,
                {
                    onSuccess: () => {
                        this.form.uom = ''
                        this.form.tree_uom = ''
                        this.form.tree_quantity = ''
                        this.form.quantity = ''
