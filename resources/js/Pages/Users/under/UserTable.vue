                                        ...
                                        <div class="p-4 bg-white border-b border-gray-200">
                                            ...
                                            <div class="flex justify-end mt-2">
                                                <button @click="openModal()"
                                                    class="inline-flex justify-center rounded-md border border-transparent px-4 py-2
                                                     bg-green-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-green-500 
                                                     focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out 
                                                ...
                                                <table class="table table-hover text-nowrap">
                                                    ...
                                                    <tbody v-for="$user in Users.data" :key="$user.id">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <Link :href="route('Edit.user.users', $user.id)">
                                                                <i
                                                                    class="fas fa-edit text-blue-500 hover:text-blue-700 cursor-pointer" title="Edit user"></i>
                                                                </Link>
                                                            </td>
                                                                <!-- <td>
                                                                    <Link :href="route('Edit.user.users', $user.id)">                                                                
                                                                    <i
                                                                        class="fas fa-trash text-red-500 hover:text-red-700 cursor-pointer"
