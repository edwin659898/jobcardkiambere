                                                        ...
                                                        <div class="flex flex-col rounded-md shadow-lg px-3 py-2 pt-3">
                                                            ...
                                                            <div v-if="SelectedOne"
                                                                ...
                                                                <input type="number"
                                                                    ...
                                                                    placeholder="Fruit Depulped">
                                                                <input type="number"
                                                                    class="w-full py-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                                    v-model="form.NutsWeighed"  step=".01"
                                                                    placeholder="Nuts weighed">
                                                            ...
                                                            <div class="flex items-center justify-around space-x-2">
                                                                ...
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.NutsWeighed">{{ form.errors.NutsWeighed
                                                                    }}
                                                                </p>
                                                            </div>
                                                                        ...
                                                                        <td>
                                                                            <ol v-for="stock, index in fruit.stocks"
                                                                                ...
                                                                                <li class="flex justify-between">
                                                                                    <p>Depulp - {{ stock.quantity }}</p>
                                                                                    <p>Nuts - {{ stock.damage_seed }}</p>
...
export default {
    ...
    methods: {
        update() {
            this.form.patch(`/Depulping/fruit-depulping/${this.form.SelectedId}`, {
