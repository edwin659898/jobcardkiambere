                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <input type="text" v-model="form.soil"  disabled
                                                                ...
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.soil">
                                                                    {{ form.errors.soil }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <select v-model="form.soil_uom" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                    <option v-for="(unit, index) in  $page.props.uom" :key="index" :value="unit">{{ unit}}</option>
                                                                </select>
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.soil_uom">
                                                                    {{ form.errors.soil_uom }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.soil_quantity"  step=".01"
                                                                    placeholder="quantity" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.soil_quantity">
                                                                    {{ form.errors.soil_quantity }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <input type="text" v-model="form.top_soil" disabled
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.top_soil">
                                                                    {{ form.errors.top_soil }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <select v-model="form.top_soil_uom" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                    <option v-for="(unit, index) in  $page.props.uom" :key="index" :value="unit">{{ unit}}</option>
                                                                </select>
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.top_soil_uom">
                                                                    {{ form.errors.top_soil_uom }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.top_soil_quantity"  step=".01"
                                                                    placeholder="quantity" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.top_soil_quantity">
                                                                    {{ form.errors.top_soil_quantity }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover text-nowrap mt-6">
                                                                ...
                                                                <tbody>
                                                                    <tr v-for="(comp, index) in BedPrepActivities"
                                                                        :key="index">
                                                                        <td>{{ index + 1 }}</td>
                                                                        <td>{{ comp.soil_quantity }}</td>
                                                                        <td>{{ comp.soil_uom }}</td>
                                                                        <td>{{ comp.top_soil_quantity }}</td>
                                                                        <td>{{ comp.top_soil_uom }}</td>
                                                                        <td>
                                                                            {{ format_date(comp.date) }}
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/potting/transportation/${id}`,
                {
                    onSuccess: () => {
                        this.form.soil_uom = '';
                        this.form.soil_quantity = '';
                        this.form.top_soil_uom = '';
                        this.form.top_soil_quantity = '';
                    },
                    preserveScroll: true
                });
        },
