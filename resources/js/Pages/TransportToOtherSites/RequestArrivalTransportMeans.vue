                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div class="flex justify-end mt-4">
                                                            <button
                                                                class="inline-flex justify-center rounded-md border border-transparent px-4 py-2 bg-green-600 text-base leading-6 font-medium text-white shadow-sm hover:bg-green-500 focus:outline-none focus:border-green-700 focus:shadow-outline-green transition ease-in-out duration-150 sm:text-sm sm:leading-5">Sign and Save</button>
                                                        </div>
                                                    </div>
                                                </form>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/transport-to-other-sites/signatures/${id}`, { preserveScroll: true });
        }
    }
}
</script>