                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div class="form-group flex items-center justify-between space-x-2">
                                                            ...
                                                            <div class="w-full">
                                                                <VueMultiselect v-model="form.seed_bed_number" track-by="id" :options="BedNumbers" label="name"
                                                        ...
                                                        <div class="form-group flex items-center justify-between space-x-2">
                                                            ...
                                                            <div class="w-full">
                                                                <select v-model="form.chemical_name" required
                                                                    ...
                                                                    <option v-for="(name, index) in  Chemicals"
                                                                        :key="index" :value="name">{{ name }}</option>
                                                                </select>
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.chemical_name">
                                                                    {{ form.errors.chemical_name }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <select v-model="form.chemical_uom" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                    <option v-for="(unit, index) in  $page.props.uom"
                                                                        :key="index" :value="unit">{{ unit }}</option>
                                                                </select>
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.chemical_uom">
                                                                    {{ form.errors.chemical_uom }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.chemical_quantity"
                                                                    step=".01" placeholder="quantity" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.chemical_quantity">
                                                                    {{ form.errors.chemical_quantity }}
                                                                </p>
                                                            </div>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/seed-propergation/watering-with-fungicide/${id}`,
                {
                    onSuccess: () => {
                        this.form.chemical_uom = '';
                        this.form.chemical_quantity = '';
                        this.form.chemical_name = '';
                        this.form.seed_bed_number = '';
                    },
                    preserveScroll: true
                });
        },
