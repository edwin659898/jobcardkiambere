                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.Goodquantity"  step=".01"
                                                                    placeholder="Good quantity" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.Goodquantity">
                                                                    {{ form.errors.Goodquantity }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.Badquantity"  step=".01"
                                                                    placeholder="Bad quantity" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.Badquantity">
                                                                    {{ form.errors.Badquantity }}
                                                                </p>
                                                            </div>
                                                        </div>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/seed-propergation/nipping-and-slitting/${id}`,
                {
                    onSuccess: () => {
                        this.form.treeNumber = ''
                        this.form.uom = ''
                        this.form.Goodquantity = ''
                        this.form.Badquantity = ''
                    },
                    preserveScroll: true
                });
        },
