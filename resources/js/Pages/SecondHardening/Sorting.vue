                                                ...
                                                <form @submit.prevent="update(Jobcard.id)">
                                                    <div class="col-sm-12 pt-8 ">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.quantityOk"  step=".01"
                                                                    placeholder="quantity ok" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.quantityOk">
                                                                    {{ form.errors.quantityOk }}
                                                                </p>
                                                            </div>
                                                            <div class="w-full">
                                                                <input type="number" v-model="form.quantityNotOk"  step=".01"
                                                                    placeholder="quantity not ok" required
                                                                    class="w-full py-1 text-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                <p class="text-xs text-red-600 mt-2"
                                                                    v-if="form.errors.quantityNotOk">
                                                                    {{ form.errors.quantityNotOk }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <table class="table table-hover text-nowrap mt-6">
                                                                <thead>
                                                                    <tr>
                                                                        <th>No</th>
                                                                        <th>Tree Number</th>
                                                                        <th>Seedling Bed Number</th>
                                                                        <th>UOM</th>
                                                                        <th>Quantity Ok</th>
                                                                        <th>Quantity Not Ok</th>
                                                                        <th>Date</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
...
export default {
    ...
    methods: {
        update(id) {
            this.form.patch(`/first-hardening/sort-seeds-out/${id}`,
                {
                    onSuccess: () => {
                        this.form.name = ''
                        this.form.uom = ''
                        this.form.quantityOk = ''
                        this.form.quantityNotOk = ''
