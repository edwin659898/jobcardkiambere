                                                    ...
                                                    <form @submit.prevent="update()">
                                                        ...
                                                        <div class="flex flex-col rounded-md shadow-lg px-3 py-2 pt-3">
                                                            ...
                                                            <div v-if="SelectedOne"
                                                                ...
                                                                <input type="number"
                                                                    class="w-full py-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                                    v-model="form.Goodquantity" placeholder="Good Seed">
                                                                <input type="number"
                                                                    class="w-full py-1 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                                                                    v-model="form.Badquantity"
                                                                    placeholder="Rejected Seed">
                                                               <button :class="{ 'opacity-25': form.processing }" :disabled="form.processing"
                                                            ...
                                                            <p class="text-xs text-red-600 mt-2"
                                                                v-if="form.errors.receivedBy">{{  form.errors.receivedBy 
                                                                }}
                                                            </p>
...
export default {
    ...
    methods: {
        update() {
            this.form.patch(`/seed-extraction/sorting/${this.form.SelectedId}`, {
        ...
        selected(id) {
            this.form.Goodquantity = null;
            this.form.Badquantity = null;
